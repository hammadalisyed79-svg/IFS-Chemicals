...
SCREEN_TITLES = {
    ...
    "Production from Physical": "Production from Physical",
    ...
    "Zero Movement Accounts": "Zero Movement",
...
SCREEN_TAGLINES = {
    ...
    "Production from Physical": "Phy in → production auto",
    ...
    "Zero Movement Accounts": "No debit / credit / activity",
    ...
    "Payroll": "Salary runs",
    "Employee Advances": "Salary advance — 100% from next pay",
    "Employee Loans": "Employee loans — payroll installments",
...
NAV_GROUPS = {
    ...
    "Finance": ["Cash Book", "Bank Book", "Customer Receipt", "Supplier Payment", "Expense Payment",
                ...
                "Trial Balance", "Zero Movement Accounts", "Profit & Loss Report", "Balance Sheet",
                "Fiscal Year Closing"],
    "HR": ["Employees", "Attendance", "Leave Management", "Payroll", "Employee Advances", "Employee Loans", "Employee Ledger"],
...
SCREEN_PERMISSION = {
    ...
    "Production from Physical": "Inventory",
    "Stock Revaluation": "Inventory",
    ...
    "General Ledger": "Finance", "Trial Balance": "Finance",
    "Zero Movement Accounts": "Finance", "Profit & Loss Report": "Finance",
