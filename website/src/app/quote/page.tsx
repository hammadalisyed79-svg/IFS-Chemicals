...
export const metadata: Metadata = pageMeta({
  ...
  description:
    "Build a product quote list from the IFS Chemicals catalogue and submit for trade pricing. No online checkout — our commercial team responds with pricing.",
  path: "/quote",
});
    ...
    <div className="bg-[var(--paper)]">
      <div className="bg-[var(--navy)] text-white">
        <div className="container-site pb-12 pt-10 md:pb-20 md:pt-16">
          <p className="eyebrow !text-white/70">Quote</p>
          ...
          <p className="mt-4 max-w-xl text-[0.98rem] leading-relaxed text-white/70 md:mt-5 md:text-[1.05rem]">
            Select products, adjust quantities, and submit your list. Our
            commercial team responds with pricing — there is no online checkout
            on this site.
          </p>
